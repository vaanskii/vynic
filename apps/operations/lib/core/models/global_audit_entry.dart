...
abstract final class GlobalAuditPresentation {
  static const Map<String, String> _actionLabels = {
    ...
    GlobalAuditAction.receivingCreated: 'Receiving created',
    GlobalAuditAction.receivingUpdated: 'Receiving updated',
    GlobalAuditAction.receivingPosted: 'Receiving posted',
    GlobalAuditAction.receivingCancelled: 'Receiving cancelled',
    GlobalAuditAction.recipeCreated: 'Recipe created',
    GlobalAuditAction.recipeUpdated: 'Recipe updated',
    GlobalAuditAction.recipeDisabled: 'Recipe disabled',
  ...
  static const Map<String, String> _entityLabels = {
    ...
    GlobalAuditEntity.receiving: 'Receiving',
    GlobalAuditEntity.recipe: 'Recipe',
