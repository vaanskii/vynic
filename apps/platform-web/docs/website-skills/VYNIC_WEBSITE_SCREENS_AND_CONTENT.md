...
- `Run tables, orders, reservations, payments, and manager visibility from one offline-first system.`
...
Guest chooses a date, table, time, and optional preorder items. The reservation lands in Vynic for staff to manage.
...
- Be concrete: "Guests reserve a table online and staff manage it in Vynic."
