...
export function VenueDevicesTab({ venueId, venueName }: { venueId: string; venueName: string }) {
  ...
  return <>
    <Panel title="POS devices" description="Last seen is reported by the backend. No online/offline state is inferred." action={<Button tone="primary" onClick={() => setCreateOpen(true)}><Plus size={16} /> Add POS device</Button>}>
