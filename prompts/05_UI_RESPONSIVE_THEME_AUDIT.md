...
detailed design sub-plan in `plan.md`.

---

Modernize Vynic's UI for responsiveness and a shared theme. Read
`docs/VYNIC_PROJECT_PLAN.md` §5 and §6 (Phases 5–6), then `plan.md` (the detailed
design system plan).
...
1. **Phase 5a — theme:** introduce shared tokens/`ThemeData` per `plan.md`; migrate
...
- Do not change business logic, order/close-day/print/sync behavior while
  restyling — `plan.md` says the same.
