...
- Georgian operators who care about GEL, local payment context, Georgian language, service fee, banquets, and non-fiscal close.
...
4. Online reservations: guests can choose tables, attach preorder items, and send the reservation to staff.
...
7. Georgian operational fit: Georgian UI, GEL pricing, banquet packages, local payment context, and service fee.
...
- The current public API supports menu, table availability, reservations, website user auth, and admin-only reservation views.
...
- "Guests can reserve online and staff can manage the booking."
